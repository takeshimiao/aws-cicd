"""
Brought from https://github.com/RealSalmon/lambda-backed-cloud-formation-kms-encryption/blob/master/lambda_function.py
and made some modifications to align with our usecase
"""
import base64
import uuid
import httplib
